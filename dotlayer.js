...
google.maps.DotLayer.prototype.onAdd = function () {
	...
	// We don't need to create the material more than once
	if (!this.firstRun) {
		this.redraw();
	} else {
		this.draw();
...
google.maps.DotLayer.prototype.onRemove = function () {
	...
	self.clear(function () {
		...
		if (self.changeHandler) {
			google.maps.event.removeListener(self.changeHandler);
...
/**
 * This method will clear the DotLayer asynchronously
 */
google.maps.DotLayer.prototype.clear = function (callback) {
	if (this.scene.children.length) {
		obj = this.scene.children.pop();
		if (obj.is_ob) {
...
google.maps.DotLayer.prototype.redraw = function () {
	this.scene.originalparticles = this.scene.originalparticles || this.scene.children[0];
